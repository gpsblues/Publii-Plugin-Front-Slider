...
var VanillaSlider = /*#__PURE__*/function () {
  ...
  function VanillaSlider(containerId) {
    ...
    this.webpSupported(function (isWebpSupported) {
      //my adds
      _this.textLeftRight = options.textLeftRight || '40px'
      _this.textTopBottom = options.textTopBottom || '40px'
      _this.textPadding = options.textPadding || '20px'
      //end my add
      ...
      _this.setSlideText = function (index) {
        var appendTextOverlay = function appendTextOverlay(title, body, position, index) {
          ...
          _this.textOverlay.style.padding = _this.textPadding;
          ...
          switch (position) {
            case 'NW':
              _this.textOverlay.style.top = _this.textTopBottom;
              _this.textOverlay.style.left = _this.textLeftRight;
              break;

            case 'NE':
              _this.textOverlay.style.top = _this.textTopBottom;
              _this.textOverlay.style.right = _this.textLeftRight;
              break;

            case 'SE':
              _this.textOverlay.style.bottom = _this.textTopBottom;
              _this.textOverlay.style.right = _this.textLeftRight;
              break;
